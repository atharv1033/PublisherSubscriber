...
public class SubscriberPostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_subscriber_post);
        ...
        postName_textView = findViewById(R.id.sub_postName_textView);
        postContent_textView = findViewById(R.id.sub_postContent_textView);
